...
//       router.replace("./home"); // You can redirect to home/feed later
//     } catch (err) {
...
//       <TextInput placeholder="Enter your password" style={styles.input} onChangeText={setPassword} secureTextEntry />
...
//   button: { backgroundColor: "#16a34a", padding: 15, borderRadius: 10, alignItems: "center" },
...
//       await saveToken(res.data.token);
//       router.replace("../(tabs)/home"); // You can redirect to home/feed later
//     } catch (err) {
//       Alert.alert("Signup Error", err.response?.data?.message || "Something went wrong");
//     }
//   };
...
//       {/* Heading */}
//       <Text style={styles.heading}>Lets{`'`}s{"\n"}Get Started</Text>
